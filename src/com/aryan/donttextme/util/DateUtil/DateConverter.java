...
public final class DateConverter {
    ...
    public static final IslamicDate civilToIslamic(MiladiDate miladi) {
        return jdnToIslamic(civilToJdn(miladi));
    }

    public static final long civilToJdn(MiladiDate miladi) {

        long lYear = miladi.getYear();
        long lMonth = miladi.getMonth();
        long lDay = miladi.getDayOfMonth();
    ...
    // ine ...
    public static final PersianDate civilToPersian(MiladiDate miladi) {
        return jdnToPersian(civilToJdn(miladi));
    }
...
//        return (long) Math.floor(d);
    ...
    public static final MiladiDate islamicToCivil(IslamicDate islamic) {
    ...
    public static final MiladiDate jdnToCivil(long jdn) {
    ...
    public static final IslamicDate jdnToIslamic(long jd) {
        ...
        MiladiDate miladi = jdnToCivil(jd);
        int year = miladi.getYear();
        int month = miladi.getMonth();
        int day = miladi.getDayOfMonth();
    ...
    // TODO Is it correct to return a MiladiDate as a JulianDate?
    public static final MiladiDate jdnToJulian(long jdn) {
        long j = jdn + 1402;
        long k = ((j - 1) / 1461);
        long l = j - 1461 * k;
    ...
    public static final PersianDate jdnToPersian(long jdn) {
        ...
        if (yday <= 186)
            month = (int) ceil(yday / 31d);
        else
            month = (int) ceil((yday - 6) / 30d);
    ...
    public static final MiladiDate persianToCivil(PersianDate persian) {
